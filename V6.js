            ...
            if (($(".selected").length + $(".wrong").length) >= totalSelected) {
                ...
                if ($(".wrong").length == 0) {
                    if((cols+rows)%4 == 0){
                       ...
                       $(".content").html("<div style = 'position: absolute; left: 785px; top: 300px'> <img class = 'animated wobble' src = '1up.png' height = '50' width = '50'> </div>");                    
                    
                       $("#lives").append($("<a>", {
                         html: $("<img>", { src: 'life.png', height: 30, width: 30, class: 'animated rollIn' })
                        }));
                    }
                    if (cols == rows) {
                        cols++;
